...
namespace Microsoft.Identity.Client.Platforms.net7win
{
    /// <summary>
    ///     Platform / OS specific logic.
    /// </summary>
    internal class Net7WinPlatformProxy : NetCorePlatformProxy
    {
        /// <inheritdoc/>
        public Net7WinPlatformProxy(ILoggerAdapter logger)
            : base(logger)
        {
        }
